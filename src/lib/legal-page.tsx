    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "账号二维码由服务端签发，仅在点击生成时出现，有效期为 15 分钟且仅能恢复一次。服务端只保存二维码凭证的不可逆摘要；二维码本身等同于账号钥匙，请勿转发、截图给他人或保存到公共相册。",
          "旧版本仅依赖浏览器 userId 的匿名身份不再被信任。升级后需建立新的安全设备凭证，或使用仍在有效期内的二维码凭证恢复账号。",
        ],
      },
      {
        heading: "五、保存期限与删除规则",
        items: [
          ...
          "二维码恢复凭证最长保存 15 分钟，使用后立即失效；设备会话最长有效 180 天，过期后无法继续访问账号记录。",
